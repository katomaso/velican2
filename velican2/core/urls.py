...
urlpatterns = [
    ...
    path("sites/<str:site>/update.html", views.SiteEdit.as_view(), name="site-edit"),
    ...
    path("sites/<str:site>/category/create.html", views.CategoryCreate.as_view(), name="category-add"),
    path("sites/<str:site>/post/create.html", views.PostCreate.as_view(), name="post-add"),
    path("sites/<str:site>/post/<int:post>/update.html", views.Post.as_view(), name="post"),
